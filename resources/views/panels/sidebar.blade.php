...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="col-md-12">
    <a href="{{url('/admin')}}">
    <img class=" mx-auto mt-2 pl-2" src="https://iconape.com/wp-content/files/na/246732/svg/246732.svg" style="width: 90%;margin:10px auto;">
      {{-- <h2 class="brand-text ml-2 mt-2"> sports council</h2> --}}
    </a>
  </div>
